        ...
        <div className='w-full overflow-hidden flex flex-col sm:justify-center items-center pt-6 sm:pt-0'>
            ...
            <LoginContainer className='w-full sm:max-w-sm px-6 py-4 overflow-hidden absolute inset-0'>
                ...
                <div className='flex h-auto w-full'>
                    <ApplicationLogo className="w-[45vw] sm:w-[200px] m-auto"/>
                    <SecondApplicationLogo className="w-[30vw] sm:w-[120px] m-auto" />
                </div>
                    ...
                    <div className="flex items-center justify-end mt-4">
                        {canResetPassword && (
                            <Link
                                ...
                                className="text-center hover:text-theme-blue-lighter text-sm text-theme-blue-2 dark:text-theme-blue-2 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                            >
                                Esqueceu sua senha?
                            </Link>
                        )}
